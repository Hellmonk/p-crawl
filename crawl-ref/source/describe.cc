...
static const vector<property_descriptor> & _get_all_artp_desc_data()
{
    static vector<property_descriptor> data =
    {
        ...
        { ARTP_MUTATE,
            ...
            prop_note::plain },
        { ARTP_HASTE,
            "It will briefly haste you when you enter a new floor.",
            prop_note::plain },
        { ARTP_MIGHT,
            "It will make you briefly mighty when you enter a new floor.",
            prop_note::plain },
        { ARTP_CORRODE,
            "It will corrode you when you enter a new floor.",
            prop_note::plain },
        { ARTP_DRAIN,
            "It drains your maximum health when unequipped.",
            prop_note::plain },
        { ARTP_SLOW,
            "It will slow you when you enter a new floor.",
            prop_note::plain },
        { ARTP_SHIELDING,
        ...
        { ARTP_HARM,
            ...
            prop_note::plain },
        { ARTP_DETECTION,
            "It helps you locate dungeon features.",
            prop_note::plain },
        { ARTP_RANGE_SLAY,
            "It adds +5 slaying to ranged or thrown weapons.",
            prop_note::plain },
        { ARTP_RAMPAGING,
            "It bestows one extra step when moving towards enemies.",
            prop_note::plain },
        { ARTP_STEALTH,
            "buggy stealth",
            prop_note::symbolic },
        ...
        { ARTP_WIZARDRY,
            ...
            prop_note::plain },
        { ARTP_SILENCE,
            "It will silence you when you descend to a new floor.",
            prop_note::plain },
        { ARTP_BANE,
