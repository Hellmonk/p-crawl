...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<2, 6, 1, 1>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 9, 1, 1>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 4, 3, 1>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 1, 4, 1>,
    new tohit_calculator<30>,
    RED,
    false,
    BEAM_FIRE,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 3, 1, 1>,
    new tohit_calculator<AUTOMATIC_HIT>,
    LIGHTCYAN,
    false,
    BEAM_ELECTRICITY,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 0, 1, 1>,
    new tohit_calculator<30>,
    RED,
    false,
    BEAM_FIRE,
...

{
    ...
    new dicedef_calculator<2, 4, 1, 10>,
    new tohit_calculator<8, 1, 10>,
    new dicedef_calculator<1, 5, 1, 1>,
    new tohit_calculator<25, 1, 40>,
    WHITE,
    false,
    BEAM_COLD,
...

{
    ...
    new dicedef_calculator<1, 14, 1, 1>,
...

{
    ...
    new calcdice_calculator<6, 18, 2, 3>,
    new tohit_calculator<10, 1, 25>,
    new dicedef_calculator<2, 8, 1, 1>,
    new tohit_calculator<17, 1, 25>,
    WHITE,
    false,
    BEAM_COLD,
...

{
    ZAP_FIREBALL,
    "fireball",
    new calcdice_calculator<1, 4, 3, 2>,
    new tohit_calculator<40>,
    new dicedef_calculator<3, 3, 1, 2>,
    new tohit_calculator<40>,
    RED,
    false,
    BEAM_FIRE,
...

{
    ZAP_BLASTMOTE,
    "concussive blast",
    new calcdice_calculator<2, 20, 1, 1>,
    new tohit_calculator<40>,
    nullptr,
    nullptr,
    RED,
...

{
    ZAP_FLAME_WAVE,
    "flame wave",
    new calcdice_calculator<2, 12, 1, 1>,
    new tohit_calculator<40>,
    nullptr,
    nullptr,
    RED,
...

{
    ...
    new dicedef_calculator<1, 10, 1, 1>,
...

{
    ...
    new tohit_calculator<8, 1, 20>,
    new dicedef_calculator<2, 4, 1, 1>,
    new tohit_calculator<17, 1, 25>,
    DARKGREY,
    false,
    BEAM_NEG,
...

{
    ...
    new dicedef_calculator<1, 16, 4, 1>,
...

{
    ZAP_DISPEL_UNDEAD,
    "",
    new dicedef_calculator<3, 20, 1, 1>,
    new tohit_calculator<0, 3, 2>,
    new dicedef_calculator<3, 3, 1, 10>,
    new tohit_calculator<AUTOMATIC_HIT>,
    BLACK,
...

{
    ...
    new tohit_calculator<8, 1, 10>,
    new dicedef_calculator<2, 3, 1, 1>,
    new tohit_calculator<14, 1, 35>,
    LIGHTGREY,
    false,
    BEAM_MMISSILE,
...

{
    ZAP_SHOCK,
    "zap",
    new dicedef_calculator<1, 7, 1, 1>,
...

{
    ...
    new tohit_calculator<40>,
    new dicedef_calculator<1, 15, 2, 1>,
    new tohit_calculator<40>,
    LIGHTBLUE,
    false,
    BEAM_ELECTRICITY,
...

{
    ZAP_GLACIAL_BREATH,
    "glacial breath",
    new dicedef_calculator<2, 6, 4, 3>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 17, 0, 1>,
    new tohit_calculator<20, 1, 4>,
    YELLOW,
    false,
    BEAM_ACID,
...

{
    ...
    new tohit_calculator<AUTOMATIC_HIT>,
    new dicedef_calculator<1, 6, 1, 1>,
    new tohit_calculator<AUTOMATIC_HIT>,
    BLACK,
    true,
...

{
    ZAP_BREATHE_STEAM,
    "ball of steam",
    new dicedef_calculator<2, 4, 2, 3>,
    new tohit_calculator<10, 1, 10>,
    new dicedef_calculator<1, 3, 1, 2>,
...

{
    ZAP_BOLT_OF_MAGMA,
    "bolt of magma",
    new dicedef_calculator<2, 16, 2, 3>,
...

{
    ...
    new calcdice_calculator<6, 18, 2, 3>,
    new tohit_calculator<10, 1, 25>,
    new dicedef_calculator<1, 11, 1, 1>,
    new tohit_calculator<17, 1, 25>,
    RED,
    false,
    BEAM_FIRE,
...

{
    ZAP_UNRAVELLING,
    "unravelling",
    new dicedef_calculator<1, 8, 1, 2>,
    new tohit_calculator<0, 1, 1>,
    nullptr,
    nullptr,
    ETC_MUTAGENIC,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 7, 0, 1>,
    new tohit_calculator<17, 1, 25>,
    CYAN,
    false,
    BEAM_MMISSILE,
...

{
    ZAP_FIRE_STORM,
    "great blast of fire",
    new calcdice_calculator<8, 40, 1, 1>,
    new tohit_calculator<40>,
...

{
    ...
    new dicedef_calculator<1, 7, 0, 1>,
    new tohit_calculator<AUTOMATIC_HIT>,
    new dicedef_calculator<1, 1, 1, 1>,
    new tohit_calculator<AUTOMATIC_HIT>,
    RED,
    false,
    BEAM_FIRE,
...

{
    ZAP_INACCURACY,
    "trick lightning",
    new calcdice_calculator<4, 40, 2, 1>,
    new tohit_calculator<AUTOMATIC_MISS>,
...

{
    ZAP_PLASMA,
    "fiery plasma",
    new dicedef_calculator<1, 10, 3, 1>,
    new tohit_calculator<7, 1, 40>,
...

{
    ZAP_GALVANIC_BREATH,
    "arc of electricity",
    new dicedef_calculator<2, 3, 9, 10>,
    new tohit_calculator<AUTOMATIC_HIT>,
    nullptr,
    nullptr,
    LIGHTCYAN,
...

{
    ...
    new dicedef_calculator<3, 6, 1, 3>,
    new tohit_calculator<AUTOMATIC_HIT>,
    nullptr,
    nullptr,
    ETC_ICE,
...

{
    ZAP_GRAVE_CLAW,
    "jagged bones",
    new dicedef_calculator<2, 7, 1, 3>,
    new tohit_calculator<AUTOMATIC_HIT>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<4, 4, 2, 3>,
    new tohit_calculator<AUTOMATIC_HIT>,
    CYAN,
    false,
    BEAM_ICE,
...

{
    ...
    new tohit_calculator<AUTOMATIC_HIT>,
    new dicedef_calculator<4, 1, 1, 1>,
    new tohit_calculator<AUTOMATIC_HIT>,
    WHITE,
    false,
    BEAM_MMISSILE,
...

{
    ZAP_FORTRESS_BLAST,
    "fortress blast",
    new dicedef_calculator<6, 1, 3, 17>,
    new tohit_calculator<AUTOMATIC_HIT>,
    new dicedef_calculator<6, 1, 1, 6>,
    new tohit_calculator<AUTOMATIC_HIT>,
    WHITE,
    false,
    BEAM_MMISSILE,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<3, 1, 1, 1>,
    new tohit_calculator<AUTOMATIC_HIT>,
    YELLOW,
    false,
    BEAM_SEISMIC,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<2, 5, 1, 6>,
    new tohit_calculator<30>,
    MAGENTA,
    false,
    BEAM_MMISSILE,
...

{
    ZAP_ACID_BALL,
    "ball of acid",
    new dicedef_calculator<3, 5, 3, 1>,
    new tohit_calculator<40>,
...

{
    ...
    nullptr,
    nullptr,
    new calcdice_calculator<1, 3, 3, 1>,
    new tohit_calculator<18, 3, 24>,
    BROWN,
    false,
    BEAM_MMISSILE,
